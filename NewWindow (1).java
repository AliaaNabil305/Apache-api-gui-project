...
import java.io.IOException;
	...
	public class NewWindow  {
       ...
       Rectangle object = new Rectangle (20,20,200,100);
       ...
       Group root1 = new Group(object_l);
        StackPane p1 = new StackPane();
         ...
         object.widthProperty().bind(stage.widthProperty().divide(no_object*0.7));
         object.heightProperty().bind(stage.heightProperty().divide(no_object*2));
         
        
       Rectangle object_fields = new Rectangle (35,35,200,290);
       ...
       object_fields.widthProperty().bind(stage.widthProperty().divide(no_object*0.7));
       object_fields.heightProperty().bind(stage.heightProperty().divide(no_object*0.5));
       VBox p3= new VBox();
       ...
       p3.getChildren().addAll(p1,p2);
        ...
        y.setPadding(new Insets(30, 5, 5, 30));
